...
<body>
				...
				<div class="row">
					...
					<div class="col-7 search">
						<div class="input-group mb-3">
							...
							<button class="btn btn-outline-secondary button-addon2" type="button"><i class="fas fa-search"></i></button>
						</div>
					</div>
				...
				<div class="overlay">
					<div class="overlay-content">
						...
						<ul class="menu">
							...
							<li class="menu-has-children dishes-menu">
								<a href="#">Menu</a>
								<ul class="sub-menu-mobile">
	...
	<main>
		<section class="home">
			<div class="container">
				<div class="row ">
					...
					<div class="col-md-6">
						<img src="images/home.png" alt="home-page" loading="lazy">
					</div>
				</div>
			</div>
		</section>
				...
				<div class="row">
					<div class="col-md-6">
						<div class="about-image desktop">
							<img src="images/about.jpg" alt="about-image" loading="lazy">
						</div>
					</div>
					<div class="col-md-6">
						<div class="content">
							...
							<p>We cook the best food in the entire city, with excellent customer service, the best meals and at the besst price, visit us.</p>
							<button type="button" class="btn btn-success">Explore History</button>
						</div>
					</div>
		...
		<section class="dishes">
			<div class="container">
				<p class="sub-title">Special</p>
				<h2>Menu of the week</h2>
				<div class="row menu-card-group">
					<div class="col-md-4 col-6">
						<div class="menu-card">
							<a href="#"><img src="images/plate1.png" alt="plate" loading="lazy"></a>
							<div class="menu-content">
								<div class="menu-content-title">
									<a href="#"><h3>Barbecue salad</h3></a>
								</div>
								<p>Delicious dish</p>
					...
					<div class="col-md-4 col-6">
						<div class="menu-card">
							<a href="#"><img src="images/plate2.png" alt="plate" loading="lazy"></a>
							<div class="menu-content">
								<div class="menu-content-title">
									<a href="#"><h3>Salad with fish</h3></a>
								</div>
								<p>Delicious dish</p>
					...
					<div class="col-md-4 col-6">
						<div class="menu-card">
							<a href="#"><img src="images/plate3.png" alt="plate" loading="lazy"></a>
							<div class="menu-content">
								<div class="menu-content-title">
									<a href="#"><h3>Spinach salad</h3></a>
								</div>
								<p>Delicious dish</p>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-5 desktop">
						<img class="phone" src="images/mobile-app.png" alt="mobile-app" loading="lazy">
					</div>
					<div class="col-md-7">
						<div class="content">
							<p class="sub-title">App</p>
							<h2>App is avilable</h2>
							<p>Find our application and download it, you can make reservations, food orders, see your deliceries on the way and much more.</p>
							<div class="row">
								<a href="#" class="col-md-6 col-6"><img src="images/app1.png" alt="app" loading="lazy"></a>
								<a href="#" class="col-md-6 col-6"><img src="images/app2.png" alt="app" loading="lazy"></a>
							</div>
						</div>
					</div>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-6 consult">
						<div class="content">
							<p class="sub-title">Let's talk</p>
							<h2>Contact us</h2>
							<p>If you want to reserve a table in our restaurant, con tact us and we will attend you quickly, with our 24/7 chat service.</p>
						</div>
					</div>
					<div class="col-md-6 consult">
						<div class="consult-form">
							<form method="post" action="#">
								...
								<input type="email" name="mail" placeholder="Your email" class="form-control"><br>
								<input type="tel" name="tel" placeholder="Your telephone number" class="form-control"><br>
								<textarea name="Content" placeholder="Content" class="form-control" rows="3"></textarea><br>
